# AASN
<b>Network interaction recovery using toy data from UCI Machine Learning Repository</b> (http://archive.ics.uci.edu/ml/datasets/Abscisic+Acid+Signaling+Network)
